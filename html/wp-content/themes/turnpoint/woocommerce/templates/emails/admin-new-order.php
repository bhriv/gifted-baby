...
<p><?php printf( __( 'You have received an Course Booking from %s. Their Course Booking is as follows:', 'woocommerce' ), $order->billing_first_name . ' ' . $order->billing_last_name ); ?></p>
