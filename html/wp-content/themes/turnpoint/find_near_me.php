<?php /* Template Name: Studios Near Me */?>
<?php//include_once( get_stylesheet_directory() . '/location_geo.php'); ?> 
<div class="wrapper">
  <header>
    <div>
  ...
  <div id="left_side">
    <section>
      ...
      <div id="map"></div>
      <style type="text/css">#map{min-height: 700px !important;display: block;} #map_results h1{margin-top: 16px;}</style>
      <?php  
        // debug
          //print_r($_COOKIE); 
  ...
  <div id="right_side" class="hidden">
    <section id="map_results">
      <h1>Studios Near You<br><small>Production, Mixing, Mastering, Recording, Writing</small></h1>
      <p><i class="fa fa-eye"></i> Studios in your current location are visible on the map. Zoom out to see studios in other locations.</p>
      <div class="clearfix"></div>
      <div class="card_deck">
  <?php $card_count = 0; ?>
    <?php while( $map_posts->have_posts() ) : $map_posts->the_post(); $card_count++; ?>
